...
const DishCard = memo(({ dish, index }) => {
  return (
    <motion.article
...
export default function MenuPreview() {
  ...
  return (
    <section className="relative bg-zinc-950 py-28 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#c49c00]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16" role="list">
          {loading ? (
            ...
            >
              ...
              <p className="text-xl text-zinc-400 mb-2">No dishes available yet</p>
              <p className="text-sm text-zinc-600">Check back soon for our featured menu items</p>
            </motion.div>
          )}
        </div>
