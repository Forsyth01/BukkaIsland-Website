...
import { Filter, ChefHat, Star, Flame, ArrowRight } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="text-6xl md:text-7xl font-black mb-4">
            Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Menu</span>
          </h1>
            ...
            <motion.button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full font-semibold transition-all duration-300 ${
                activeCategory === cat
                  ...
                  : "bg-zinc-900 text-zinc-300 border border-zinc-800 hover:border-amber-500/50 hover:text-white"
              }`}
            >
            ...
            >
              {filteredDishes.map((dish, i) => (
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                  className="group relative bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-2xl overflow-hidden border border-zinc-800 hover:border-amber-500/50 transition-all duration-300 flex flex-col"
                >
                  {/* Popular Badge */}
                  {dish.popular && (
                    <motion.div
                      ...
                      className="absolute top-4 left-4 bg-gradient-to-r from-amber-500 to-orange-600 text-white px-4 py-2 rounded-full text-xs flex items-center gap-2 z-10 font-bold shadow-lg"
                    >
                  ...
                  {/* Dish Image */}
                  <div className="relative h-56 overflow-hidden bg-gradient-to-br from-amber-500/10 to-orange-600/10">
                    <Image
                      src={dish.imageUrl}
                      alt={dish.name}
                      width={400}
                      ...
                      {dish.orderLink ? (
                        ...
                        >
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-5 py-2 rounded-full text-sm font-bold hover:shadow-lg hover:shadow-amber-500/40 transition-all flex items-center gap-2 group/btn"
                          >
                            Order
