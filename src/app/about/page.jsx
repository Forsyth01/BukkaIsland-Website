...
export default function About() {
  ...
  const galleryMedia = [
    ...
    },
    {
      ...
      alt: "Team members at the food truck",
    },
    {
      id: 3,
      type: "image",
      src: "/gallery/image-3.jpg",
      alt: "Three founders at BukkaIsland truck",
    },
    {
      id: 4,
      type: "video",
      src: "/gallery/video-4.mp4",
      alt: "BukkaIsland video showcase",
    },
    {
      id: 11,
      type: "video",
      src: "/gallery/video-3.mp4",
      alt: "BukkaIsland experience",
    },
    {
      id: 5,
      type: "image",
      src: "/gallery/image-5.jpg",
      alt: "Full team night shot",
    },
    {
      id: 6,
      type: "image",
      src: "/gallery/image-6.jpg",
      alt: "BukkaIsland team of five",
    },
    {
      id: 7,
      type: "image",
      src: "/gallery/image-7.jpg",
      alt: "Customer ordering at the window",
    },
    {
      id: 8,
      type: "image",
    ...
    },
    {
      ...
      alt: "Night service at BukkaIsland",
    },
    {
      id: 10,
      type: "image",
      src: "/gallery/image-10.jpg",
      alt: "Two founders inside",
    },
    {
      id: 12,
      type: "image",
      src: "/gallery/image-11.jpg",
      alt: "Team at service window",
    },
    {
      id: 13,
      type: "image",
      src: "/gallery/image-12.jpg",
      alt: "Founders with BukkaIsland banner",
    },
    {
      id: 14,
      type: "image",
      src: "/gallery/image-13.jpg",
      alt: "Busy night with customers",
    },
    {
      id: 15,
      type: "image",
      src: "/gallery/image-14.jpg",
      alt: "Large crowd at night event",
    },
    {
      id: 16,
      type: "image",
    ...
    },
    {
      ...
      alt: "Outdoor crowd gathering",
    },
    {
      id: 18,
      type: "image",
      src: "/gallery/image-17.jpg",
      alt: "Serving customers at night",
    },
    {
      id: 19,
      type: "image",
      src: "/gallery/image-18.jpg",
      alt: "Busy night service",
    },
  ];
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 transition-all duration-300 hover:border-[#e6b800]/50">
                  ...
                  <div className="relative p-6 text-center">
                    ...
                    <p className="text-zinc-400 text-sm leading-relaxed">
                      ...
                      over $10 million in AUM in the Petrochemical & Refining
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 transition-all duration-300 hover:border-[#e6b800]/50">
                  ...
                  <div className="relative p-6 text-center">
                    ...
                    <p className="text-zinc-400 text-sm leading-relaxed">
                      ...
                      digital advertising. Previously, he worked at Uber Eats
                      and drove a 150% revenue increase for a hotel when he
